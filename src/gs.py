...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_10.addItem(spacerItem, 14, 3, 1, 1)
        ...
        self.widget.setGeometry(QtCore.QRect(12, 52, 574, 387))
        self.widget.setStyleSheet("image: url(:/newPrefix/Qball.drawio.png);")
        self.widget.setObjectName("widget")
        self.gridLayout_10.addWidget(self.groupBox, 4, 0, 10, 1)
